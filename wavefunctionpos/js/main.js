...
function preload() {
    tiles[0] = loadImage("tiles/blank.JPG");
    tiles[1] = loadImage("tiles/up.JPG");
    tiles[2] = loadImage("tiles/right.JPG");
    tiles[3] = loadImage("tiles/down.JPG");
    tiles[4] = loadImage("tiles/left.JPG");
}
